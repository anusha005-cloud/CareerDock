...
public class CareerDock {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== Welcome to CareerDock 2026 ===");
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 3 -> {
                    saveReport();
                    System.out.println("Report saved to eligibility_report.txt. Goodbye!");
                    return;
                }
    ...
    private static void saveReport() {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("eligibility_report.txt"))) {
            writer.println("CareerDock - Placement Eligibility Report for " + currentStudent.name);
            for (Company c : companies) {
